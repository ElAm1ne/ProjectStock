...
public interface StockEntityRepository extends JpaRepository<Stock, Long> {
    ...
    List<Double> findOpenByTickerAndDateBetween(String ticker, Date startDate, Date endDate);

    // Method for retrieving a list of high values for a given ticker and date range
    List<Double> findHighByTickerAndDateBetween(String ticker, Date startDate, Date endDate);

    // Method for retrieving a list of low values for a given ticker and date range
    List<Double> findLowByTickerAndDateBetween(String ticker, Date startDate, Date endDate);

    // Method for retrieving a list of close values for a given ticker and date range
    List<Double> findCloseByTickerAndDateBetween(String ticker, Date startDate, Date endDate);

    // Method for retrieving a list of adjusted close values for a given ticker and date range
    List<Double> findAdjustedCloseByTickerAndDateBetween(String ticker, Date startDate, Date endDate);
    ...
    List<Double> findDividendAmountByTickerAndDateBetween(String ticker, Date startDate, Date endDate);
